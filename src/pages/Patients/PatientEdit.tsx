...
import { faUser, faCake, faPhone, faMapMarkerAlt, faVenusMars, faChevronDown, faWeightScale, faArrowsUpDown, faEnvelope } from '@fortawesome/free-solid-svg-icons';
...
import { showConfirmationAlert, showSuccessAlert, showErrorAlert, showDeleteConfirmation, showDeleteSuccessAlert } from '../../components/Alerts/PatientAlert'; 
...
const PatientEdit = () => {
    ...
    const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>) => {
        ...
        if (formData) {
            setFormData({
                ...formData,
                [name]: name === 'edad' || name === 'peso' || name === 'estatura' ? parseFloat(value) : value
            });
        }
    };
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (!validateName(formData?.nombre || '') || !validateName(formData?.apellido || '') || !validateEmail(formData?.correo || '')) {
                                ...
                                <form onSubmit={handleSubmit}>
                                    ...
                                    <div className="mb-5.5 flex flex-col gap-5.5 sm:flex-row">
                                        ...
                                        <div className="w-full sm:w-1/2">
                                            ...
                                            <div className="relative">
                                                <span className="absolute left-4.5 top-4">
                                                    <FontAwesomeIcon icon={faArrowsUpDown} opacity="0.8" />
                                                </span>
                                                <input
                                                    className="w-full rounded border border-stroke bg-gray py-3 pl-11.5 pr-4.5 text-black focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary"
                                                    type="number"
